...
mysql -uroot -e "CREATE USER 'user1'@'%' IDENTIFIED BY 'password1'"
mysql -uroot -e "grant select, insert, update, delete on test.* to user1@'%'"
mysql -uroot -e "create table test.user(pid INT, name CHAR(60), age INT)"
mysql -uroot -e "INSERT INTO test.user(pid,name,age) VALUES(1,\"allen\",20)"
mysql -uroot -e "INSERT INTO test.user(pid,name,age) VALUES(2,\"tom\",21)"
mysql -uroot -e "INSERT INTO test.user(pid,name,age) VALUES(3,\"jack\",22)"
